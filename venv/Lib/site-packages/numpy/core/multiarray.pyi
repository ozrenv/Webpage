...
# Valid time units
_UnitKind = L[
    "Y", "M", "D", "h", "m", "s", "ms", "us", "μs", "ns", "ps", "fs", "as",
]
...
def can_cast(
    from_: ArrayLike | DTypeLike, to: DTypeLike, casting: None | _CastingKind = ...,
) -> bool: ...
...
def bincount(
    x: ArrayLike, /, weights: None | ArrayLike = ..., minlength: SupportsIndex = ...,
) -> NDArray[intp]: ...
def copyto(
    dst: NDArray[Any],
    src: ArrayLike,
...
def putmask(
    a: NDArray[Any], /, mask: _ArrayLikeBool_co, values: ArrayLike,
) -> None: ...
def packbits(
    a: _ArrayLikeInt_co,
    /,
...
def ascontiguousarray(
    a: _ArrayLike[_SCT], dtype: None = ..., *, like: None | _SupportsArrayFunc = ...,
) -> NDArray[_SCT]: ...
@overload
def ascontiguousarray(
    a: object, dtype: None = ..., *, like: None | _SupportsArrayFunc = ...,
) -> NDArray[Any]: ...
@overload
def ascontiguousarray(
    a: Any, dtype: _DTypeLike[_SCT], *, like: None | _SupportsArrayFunc = ...,
) -> NDArray[_SCT]: ...
@overload
def ascontiguousarray(
    a: Any, dtype: DTypeLike, *, like: None | _SupportsArrayFunc = ...,
) -> NDArray[Any]: ...
@overload
def asfortranarray(
    a: _ArrayLike[_SCT], dtype: None = ..., *, like: None | _SupportsArrayFunc = ...,
...
def arange(  # type: ignore[misc]
    stop: _IntLike_co, /, *, dtype: None = ..., like: None | _SupportsArrayFunc = ...,
...
@overload
def arange(  # type: ignore[misc]
    stop: _FloatLike_co, /, *, dtype: None = ..., like: None | _SupportsArrayFunc = ...,
...
@overload
def arange(
    stop: _TD64Like_co, /, *, dtype: None = ..., like: None | _SupportsArrayFunc = ...,
) -> NDArray[timedelta64]: ...
@overload
def arange(
    start: _TD64Like_co,
...
@overload
def arange(
    stop: Any, /, *, dtype: _DTypeLike[_SCT], like: None | _SupportsArrayFunc = ...,
) -> NDArray[_SCT]: ...
@overload
def arange(
    start: Any,
...
@overload
def arange(
    stop: Any, /, *, dtype: DTypeLike, like: None | _SupportsArrayFunc = ...,
) -> NDArray[Any]: ...
@overload
def arange(
    start: Any,
...
_SetItemKeys = L[
    "A", "ALIGNED", "W", "WRITEABLE", "X", "WRITEBACKIFCOPY",
]
@final
class flagsobj:
