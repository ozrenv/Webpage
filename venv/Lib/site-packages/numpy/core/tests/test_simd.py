...
class _SIMD_ALL(_Test_Utility):
    ...
    @pytest.mark.parametrize(
        ...
        [("self.store_till", (32, 64), 1), ("self.store2_till", (32, 64), 2),],
    )
    ...
    @pytest.mark.parametrize(
        "intrin, elsizes, scale",
        [("self.loadn", (32, 64), 1), ("self.loadn2", (32, 64), 2),],
    )
    ...
    @pytest.mark.parametrize(
        "intrin, elsizes, scale",
        [("self.storen", (32, 64), 1), ("self.storen2", (32, 64), 2),],
    )
    ...
    @pytest.mark.parametrize(
        "intrin, elsizes, scale",
        [("self.storen_till", (32, 64), 1), ("self.storen2_till", (32, 64), 2),],
    )
