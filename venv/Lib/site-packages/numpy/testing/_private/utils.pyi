...
_ComparisonFunc = Callable[
    ...
    Union[bool, bool_, number[Any], NDArray[Union[bool_, number[Any], object_]],],
]
...
class clear_and_catch_warnings(warnings.catch_warnings):
    ...
    @overload
    def __new__(
        cls, record: L[False] = ..., modules: Iterable[types.ModuleType] = ...,
    ) -> _clear_and_catch_warnings_without_records: ...
    @overload
    def __new__(
        cls, record: L[True], modules: Iterable[types.ModuleType] = ...,
    ) -> _clear_and_catch_warnings_with_records: ...
    @overload
    def __new__(
        cls, record: bool, modules: Iterable[types.ModuleType] = ...,
...
def assert_equal(
    actual: object, desired: object, err_msg: str = ..., verbose: bool = ...,
) -> None: ...
...
@overload
def assert_array_less(
    x: _ArrayLikeTD64_co, y: _ArrayLikeTD64_co, err_msg: str = ..., verbose: bool = ...,
) -> None: ...
@overload
def assert_array_less(
    x: _ArrayLikeDT64_co, y: _ArrayLikeDT64_co, err_msg: str = ..., verbose: bool = ...,
) -> None: ...
def runstring(
    astr: str | bytes | types.CodeType, dict: None | dict[str, Any],
) -> Any: ...
def assert_string_equal(actual: str, desired: str) -> None: ...
def rundocs(
    filename: None | str | os.PathLike[str] = ..., raise_on_error: bool = ...,
) -> None: ...
...
@overload
def assert_raises(
    expected_exception: type[_ET] | tuple[type[_ET], ...], *, msg: None | str = ...,
