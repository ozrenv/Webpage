...
class Generator:
    ...
    @overload
    def random(
        self, size: _ShapeLike = ..., *, out: None | ndarray[Any, dtype[float64]] = ...,
    ) -> ndarray[Any, dtype[float64]]: ...
    @overload
    def random(
        self,
    ...
    @overload
    def beta(
        self, a: _FloatLike_co, b: _FloatLike_co, size: None = ...,
    ...
    @overload
    def uniform(
        self, low: _FloatLike_co = ..., high: _FloatLike_co = ..., size: None = ...,
    ) -> float: ...  # type: ignore[misc]
    @overload
    def uniform(
        self,
    ...
    @overload
    def normal(
        self, loc: _FloatLike_co = ..., scale: _FloatLike_co = ..., size: None = ...,
    ) -> float: ...  # type: ignore[misc]
    @overload
    def normal(
        self,
    ...
    @overload
    def lognormal(
        self, mean: _FloatLike_co = ..., sigma: _FloatLike_co = ..., size: None = ...,
    ) -> float: ...  # type: ignore[misc]
    @overload
    def lognormal(
        self,
