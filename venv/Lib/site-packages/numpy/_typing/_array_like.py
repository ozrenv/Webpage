...
if sys.version_info >= (3, 12):
    ...
    ArrayLike = (
        Buffer
        | _DualArrayLike[dtype[Any], Union[bool, int, float, complex, str, bytes],]
    )
else:
    ArrayLike = _DualArrayLike[
        dtype[Any], Union[bool, int, float, complex, str, bytes],
    ]
...
_ArrayLikeUInt_co = _DualArrayLike[
    dtype[Union[bool_, unsignedinteger[Any]]], bool,
]
_ArrayLikeInt_co = _DualArrayLike[
    dtype[Union[bool_, integer[Any]]], Union[bool, int],
]
...
_ArrayLikeUnknown = _DualArrayLike[
    dtype[_UnknownType], _UnknownType,
]
